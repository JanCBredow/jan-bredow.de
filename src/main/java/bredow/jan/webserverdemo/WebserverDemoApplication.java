...
public class WebserverDemoApplication {
  ...
  public static class Server {
    ...
    private ConsoleLogger printConfigurationProperties(
      ...
      return LOG.logSpaced("Hostname:  \"" + databaseConfiguration.databaseHost() + "\"", 4)
    ...
    private ConsoleLogger printDatabaseUserCredentials(
      ...
      return LOG.logSpaced("Username:  \"" + databaseCredentials.username() + "\"", 4)
    ...
    private ConsoleLogger printPoolProperties(DatabasePoolConfiguration poolConfiguration) {
      return LOG.logSpaced(
              "Application-Name:                   \"" + poolConfiguration.applicationName() + "\"",
              4)
          .logSpaced(
              "Cache Server Configuration:         \""
                  + poolConfiguration.cacheServerConfiguration()
                  + "\"",
              4)
          .logSpaced(
              "Cache Prepared Statements:          \"" + poolConfiguration.cachePrepStmts() + "\"",
              4)
          .logSpaced(
              "Cache RestultSetMetadata:           \""
                  + poolConfiguration.cacheResultSetMetadata()
                  + "\"",
              4)
          .logSpaced(
              "Cache Size for Statements:          \""
                  + poolConfiguration.prepStmtCacheSize()
                  + "\"",
              4)
          .logSpaced(
              "Cache Size for Prepared Statements: \""
                  + poolConfiguration.prepStmtCacheSqlLimit()
                  + "\"",
              4)
          .space()
          .logSpaced(
              "Maximum Pool-Size:                  \"" + poolConfiguration.maximumPoolSize() + "\"",
              4)
          .logSpaced(
              "Use Server Prepared Statements?     \""
                  + poolConfiguration.useServerPrepStmts()
                  + "\"",
              4)
          .logSpaced(
              "Use Local Session State?            \""
                  + poolConfiguration.useLocalSessionState()
                  + "\"",
              4)
          .logSpaced(
              "Rewrite Batch Statements?           \""
                  + poolConfiguration.rewriteBatchedStatements()
                  + "\"",
              4)
          .logSpaced(
              "Elide Set Auto-Commits?             \""
                  + poolConfiguration.elideSetAutoCommits()
                  + "\"",
              4)
          .logSpaced(
              "Maintain Time-Stats?                \""
                  + poolConfiguration.maintainTimeStats()
                  + "\"",
              4);
    }
  }
